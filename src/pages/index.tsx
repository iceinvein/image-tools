...
import { Edit3, Maximize2, Package, RefreshCw, Sparkles } from "lucide-react";
...
export default function IndexPage() {
  return (
    <DefaultLayout>
      <SEO
        title="Image Tools - Free Online Image Converter, Resizer, Editor & Asset Generator"
        description="Professional-grade image processing tools that run entirely in your browser. Convert, resize, crop, rotate, enhance images, and generate web/app assets with complete privacy. No uploads, 100% free."
        keywords="image converter, image resizer, image editor, asset generator, favicon generator, app icon generator, online image tools, convert images, resize images, crop images, browser-based image processing, free image tools, privacy-focused image editor"
      ...
      <section className="flex flex-col items-center justify-center gap-12 py-12 md:py-20 min-h-[80vh] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl w-full px-4">
          ...
          <Card className="group relative border-2 border-orange-200/60 dark:border-orange-800/60 hover:border-orange-400/80 dark:hover:border-orange-500/80 hover:shadow-2xl hover:shadow-orange-500/20 hover:-translate-y-2 bg-gradient-to-br from-white via-orange-50/30 to-pink-50/30 dark:from-gray-900 dark:via-orange-950/20 dark:to-pink-950/20 backdrop-blur-md overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1100 transition-all ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            {/* Animated gradient background */}
