    ...
    <DefaultLayout>
      ...
      <section className="flex flex-col items-center justify-center gap-12 py-12 md:py-20 min-h-[80vh] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl w-full px-4">
          ...
          <Card className="group relative border-2 border-pink-200/60 dark:border-pink-800/60 hover:border-pink-400/80 dark:hover:border-pink-500/80 hover:shadow-2xl hover:shadow-pink-500/20 hover:-translate-y-2 bg-gradient-to-br from-white via-pink-50/30 to-purple-50/30 dark:from-gray-900 dark:via-pink-950/20 dark:to-purple-950/20 backdrop-blur-md overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1300 transition-all ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            {/* Animated gradient background */}
            ...
            <CardBody className="pt-0 pb-8 relative z-10">
              <p className="text-gray-700 dark:text-gray-300 mb-8 text-center leading-relaxed px-6">
                Design custom Open Graph images with text, images, and gradients
              </p>
              <div className="px-6">
                <Button
                  as={Link}
